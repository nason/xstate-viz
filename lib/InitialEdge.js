...
var InitialEdge = /** @class */ (function (_super) {
    ...
    InitialEdge.prototype.componentDidMount = function () {
        ...
        tracker_1.tracker.listen(id, function (data) {
    ...
    InitialEdge.prototype.render = function () {
        ...
        var rect = utils_1.relative(this.state.sourceElement.getBoundingClientRect(), svgRef);
        var top = rect.top, left = rect.left;
        var stroke = preview ? "gray" : "var(--color-edge)";
        return (react_1.default.createElement("g", null,
            react_1.default.createElement("circle", { r: "4", cx: left - 10, cy: top, fill: stroke }),
            react_1.default.createElement("path", { d: "M " + (left - 10) + "," + top + " Q " + (left - 10) + "," + (top + 10) + " " + (left -
                    1) + "," + (top + 10) + " L " + left + "," + (top + 10), stroke: stroke, strokeWidth: "2", fill: "none", markerEnd: preview ? "url(#marker-preview)" : "url(#marker)" })));
    };
    return InitialEdge;
}(react_1.default.Component));
exports.InitialEdge = InitialEdge;
//# sourceMappingURL=InitialEdge.js.map